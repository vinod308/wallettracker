                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <Field label="State" required error={errors.state}>
                                    <input value={form.state} onChange={set('state')} placeholder="Uttar Pradesh" className={inp(errors.state)} />
                                </Field>
                                ...
                                <Field label="Authorised Signatory Name" error={errors.signatoryName} hint="Name printed on invoices">
                                    <input value={form.signatoryName} onChange={set('signatoryName')} placeholder="Saurabh Gupta" className={inp(errors.signatoryName)} />
                                </Field>
                            </div>
                        </div>
                    )}
